import{_ as l,r as o,o as a,c as d,f as r,d as e,e as n,b as t,a as i}from"./app-efa3585f.js";const c={},u=e("h1",{id:"记录线上环境-jenkins-vue-打包失败-error-code-elifecycle",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#记录线上环境-jenkins-vue-打包失败-error-code-elifecycle","aria-hidden":"true"},"#"),n(" 记录线上环境 Jenkins Vue 打包失败 error code ELIFECYCLE")],-1),v=e("p",null,"Jenkins 里面的 Nodejs 版本换了下，然后自动打包的时候老是失败，提取了下日志信息。",-1),b=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>0 info it worked if it ends with ok

import{_ as o,r as p,o as t,c,f as i,d as s,e as n,b as l,a}from"./app-a1022218.js";const d={},r=a('<h1 id="优雅管理-vue-全局组件和插件" tabindex="-1"><a class="header-anchor" href="#优雅管理-vue-全局组件和插件" aria-hidden="true">#</a> 优雅管理 Vue 全局组件和插件</h1><p>随着项目的不断变大，可能有些人会把插件的引入和全局组件的注册都放到<code>main.js</code>中，导致后面<code>main.js</code>里面一大坨引入代码，看起来杂乱无比，也不利于后期进行维护，所以我们尽可能的让<code>main.js</code>看起来整洁些。此处就用到<code>webpack</code>的<code>require.context</code>功能，实现 Vue 自动注册全局组件及插件，方便全局组件和插件的管理。</p>',2),u=a(`<h2 id="全局插件管理" tabindex="-1"><a class="header-anchor" href="#全局插件管理" aria-hidden="true">#</a> 全局插件管理</h2><p>1、项目中新建<code>plugins</code>目录，和<code>components</code>目录保持同级。<br> 2、<code>plugins</code>目录中新建<code>index.js</code>，以引入<code>element-ui</code>为例：<br> 3、再<code>plugins</code>目录中新建<code>element.js</code>，写入官方的引用方法（暂不考虑按需引入问题）</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> Vue <span class="token keyword">from</span> <span class="token string">&#39;vue&#39;</span>

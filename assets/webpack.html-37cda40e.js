import{_ as s,o as n,c as a,a as e}from"./app-e45bee01.js";const p={},t=e(`<h1 id="webpack" tabindex="-1"><a class="header-anchor" href="#webpack" aria-hidden="true">#</a> webpack</h1><h1 id="_1、基本配置" tabindex="-1"><a class="header-anchor" href="#_1、基本配置" aria-hidden="true">#</a> 1、基本配置</h1><p>在项目根目录创建webpack.config.js</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
